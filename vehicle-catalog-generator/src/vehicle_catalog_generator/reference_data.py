...
VEHICLE_REFERENCES = [
    ...
    VehicleReference(
        ...
        payload_kg=None,
        gvw_kg=9_150,
        new_vehicle_price_anchor_inr=1_800_000,
        purpose_tags=["regional_delivery", "ecommerce", "fmcg", "industrial_goods"],
        spec_source_url="https://trucks.tatamotors.com/ultra/tata-ultra-t9",
    ),
    VehicleReference(
        make="Ashok Leyland",
        ...
        payload_kg=4_885,
        gvw_kg=7_490,
        new_vehicle_price_anchor_inr=1_500_000,
        purpose_tags=["city_delivery", "regional_delivery", "logistics", "industrial_goods"],
        spec_source_url=(
            "https://www.ashokleyland.com/in/lightvehicles/smallcommercialvechicles/partner/"
            "specification?productId=1645"
        ),
    ),
    VehicleReference(
        make="Eicher",
        ...
        payload_kg=None,
        gvw_kg=7_490,
        new_vehicle_price_anchor_inr=1_400_000,
        purpose_tags=["city_delivery", "last_mile", "ecommerce", "fmcg"],
        spec_source_url="https://www.eichertrucksandbuses.com/light-medium-duty-trucks/light-duty/pro-2059",
    ),
    VehicleReference(
        make="BharatBenz",
        model="1015R",
        ...
        payload_kg=None,
        gvw_kg=10_600,
        new_vehicle_price_anchor_inr=2_200_000,
        purpose_tags=["regional_delivery", "fmcg", "cold_chain", "market_transport"],
        spec_source_url="https://www.bharatbenz.com/trucks/mdt-specifications-1015r-41",
    ),
    VehicleReference(
        make="Mahindra",
        model="Furio 10",
